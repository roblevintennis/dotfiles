...
rm -rf /Applications/MAMP/htdocs/inst1

# http://internalwiki.sjc.sugarcrm.pvt/index.php/Enginerring/Build_Command_Cheat_Sheet
/usr/bin/php build.php --ver=6.5.0 --flav=ent --build_dir=/Applications/MAMP/htdocs/inst1 --clean=$1 > /dev/null 2>&1

echo "Copying config_si.php file over...so you can do 'Silent Install'"
cp /Users/rlevin/programming/sugar/config_si_inst1.php /Applications/MAMP/htdocs/inst1/ent/sugarcrm/config_si.php


echo "******* Building Toffee *******"
echo "First building sidecar..."
/usr/bin/php build.php --ver=6.5.0 --flav=ent --build_dir=/Applications/MAMP/htdocs/inst1 --dir=/Users/rlevin/programming/sugar/Mango/sidecar

popd > /dev/null 2>&1

echo "Done ..."
echo 'Now go to:
http://localhost:8888/inst1/ent/sugarcrm/install.php?goto=SilentInstall&cli=true'
