...
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" SUGARCRM - Sidecar Project Stuffs 
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
noremap <leader>gT :CommandTFlush<cr>\|:CommandT sidecar/tests<cr>

" uppercase current 'inner word' (in insert mode) 
inoremap <c-u> <esc>viwU<c-r>
" open .vimrc in vsplit; and source .vimrc respectively
...
" Wrap word with double or single quotes:
:nnoremap <leader>" viw<esc>a"<esc>hbi"<esc>lel
:nnoremap <leader>' viw<esc>a'<esc>hbi'<esc>lel

" Tag Bar - requires ctags, etc.
:nnoremap <F8> :TagbarToggle<CR>
" Navigate help files ',j' to [j]ump to tag .. ',b' to return [b]ack
:nnoremap <leader>j g<c-]>
:nnoremap <leader>b <c-o>

" So command t doesn't quit searching for files at default of 10,000
let CommandTMaxFiles = 20000
let g:CommandTCancelMap='<C-x>' " Closes command t
